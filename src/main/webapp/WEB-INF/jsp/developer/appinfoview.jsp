            ...
            <div class="x_content1">
                <form class="form-horizontal form-label-left">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" class="form-control col-md-7 col-xs-12"
                                   value="${appInfo.appFlatform.valueName}" readonly="readonly">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" class="form-control col-md-7 col-xs-12"
                                   value="${appInfo.categoryLevel11.categoryName} --> ${appInfo.categoryLevel22.categoryName} --> ${appInfo.categoryLevel33.categoryName}"
                                   readonly="readonly">
                        </div>
                    </div>
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" class="form-control col-md-7 col-xs-12"
                                   value="${appInfo.appStatus.valueName}" readonly="readonly">
                        </div>
                    </div>
                    <div class="item form-group">
                                ...
                                <c:if test="${appVersionList!=null}">
                                    <c:forEach var="appVersion" items="${appVersionList}">
                                        <tr role="row" class="odd">
                                            ...
                                            <td>${appVersion.dataDictionary.valueName }</td>
                                            <td>
