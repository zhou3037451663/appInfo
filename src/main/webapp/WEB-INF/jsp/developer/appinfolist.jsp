                            ...
                            <table id="datatable-responsive"
                                ...
                                <c:forEach var="appInfo" items="${appInfoList }" varStatus="status">
                                    <tr role="row" class="odd">
                                        ...
                                        <td>${appInfo.categoryLevel11.categoryName }
                                            -> ${appInfo.categoryLevel22.categoryName }
                                            -> ${appInfo.categoryLevel33.categoryName }</td>
                                        <td><span id="appInfoStatus${appInfo.id}">${appInfo.appStatus.valueName }</span>
                                        </td>
